...
class Weather(object):
    def __init__(self, world, changing_weather_speed,setting_weather='train'):
        self.world = world
        self.setting_weather = setting_weather
        self.reset()
    ...
    def reset(self):
        ...
        if self.setting_weather=='train':
            weather_params = carla.WeatherParameters(sun_altitude_angle=90.)
            self.world.set_weather(weather_params)
        elif self.setting_weather=='Default':
            self.world.set_weather(carla.WeatherParameters.Default)
        elif self.setting_weather=='ClearNoon':
            self.world.set_weather(carla.WeatherParameters.ClearNoon)
        elif self.setting_weather=='HardRainNoon':
            self.world.set_weather(carla.WeatherParameters.HardRainNoon)
        elif self.setting_weather=='WetCloudyNoon':
            self.world.set_weather(carla.WeatherParameters.WetCloudyNoon)
        elif self.setting_weather=='WetCloudySunset':
            self.world.set_weather(carla.WeatherParameters.WetCloudySunset)
        elif self.setting_weather=='WetNoon':
            self.world.set_weather(carla.WeatherParameters.WetNoon)
        elif self.setting_weather=='MidRainSunset':
            self.world.set_weather(carla.WeatherParameters.MidRainSunset)
        elif self.setting_weather=='MidRainyNoon':
            self.world.set_weather(carla.WeatherParameters.MidRainyNoon)
        elif self.setting_weather=='SoftRainNoon':
            self.world.set_weather(carla.WeatherParameters.SoftRainNoon)
        elif self.setting_weather=='HardRainSunset':
...
class CarlaEnv(object):
    ...
    def __init__(self,
        ...
        # weather
        self.weather = Weather(self.world, self.changing_weather_speed,setting_weather)
