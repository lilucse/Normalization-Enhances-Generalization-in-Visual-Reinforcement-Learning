...
def parse_args():
	...
	# cn
	parser.add_argument('--active_cn', default=11,type=int)
	parser.add_argument('--fix_cn', default=False, action='store_true')
	# environment
	...
	parser.add_argument('--eval_episodes', default=30, type=int) #30
	...
	assert args.algorithm in {'sac', 'rad', 'curl', 'pad', 'soda', 'drq', 'svea','drqv2','drq_cnsn','svea_cnsn'}, f'specified algorithm "{args.algorithm}" is not supported'
